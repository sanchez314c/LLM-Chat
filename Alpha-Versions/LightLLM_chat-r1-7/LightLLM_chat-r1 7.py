...
class MacOSTTS:
    ...
    def get_available_voices(self):
        ...
        try:
            ...
            voice_names = [str(voice).split('.')[-1] for voice in voices]  # Extract voice names (e.g., "Alex", "Samantha")
            pool.release()
...
class VoyeurChat(tk.Tk):
    ...
    def _configure_styles(self):
        ...
        self.style.configure("Secondary.Dark.TLabel", background=LEFT_PANEL_BG, foreground=LIGHT_TEXT, font=(FONT_FAMILY, 16))
        self.style.configure("Dark.TLabel", background=LEFT_PANEL_BG, foreground=LIGHT_TEXT, font=(FONT_FAMILY, 16))
        self.style.configure("MainDark.TLabel", background=DARK_BG, foreground=LIGHT_TEXT, font=(FONT_FAMILY, 16))
        self.style.configure("Section.TLabel", background=LEFT_PANEL_BG, foreground=LIGHT_TEXT, font=(FONT_FAMILY, 18, "bold"))
        self.style.configure("Dark.TButton", background=MEDIUM_DARK_BG, foreground=LIGHT_TEXT, bordercolor=BORDER_COLOR, borderwidth=0, relief=tk.FLAT, padding=2, font=(FONT_FAMILY, 12))
        self.style.map("Dark.TButton", background=[('active', '#3A4042')], relief=[('pressed', tk.FLAT), ('active', tk.FLAT)])
        self.style.configure("Dark.TCheckbutton", background=LEFT_PANEL_BG, foreground=LIGHT_TEXT, font=(FONT_FAMILY, 12))
        self.style.map("Dark.TCheckbutton", background=[('active', SELECT_BG_COLOR)], foreground=[('active', LIGHT_TEXT)])
        self.style.configure("Dark.TMenubutton", background=MEDIUM_DARK_BG, foreground=LIGHT_TEXT, bordercolor=BORDER_COLOR, borderwidth=0, relief=tk.FLAT, arrowcolor=LIGHT_TEXT, padding=2, font=(FONT_FAMILY, 16))
        ...
        self.style.configure("Dark.TEntry", fieldbackground=MEDIUM_DARK_BG, foreground=LIGHT_TEXT, bordercolor=BORDER_COLOR, borderwidth=0, relief=tk.FLAT, insertcolor=LIGHT_TEXT, padding=2, font=(FONT_FAMILY, 16))
        ...
        self.style.configure("Secondary.Light.TLabel", background=LIGHT_LEFT_PANEL_BG, foreground=LIGHT_TEXT_DARK, font=(FONT_FAMILY, 16))
        self.style.configure("Light.TLabel", background=LIGHT_LEFT_PANEL_BG, foreground=LIGHT_TEXT_DARK, font=(FONT_FAMILY, 16))
        self.style.configure("MainLight.TLabel", background=LIGHT_BG, foreground=LIGHT_TEXT_DARK, font=(FONT_FAMILY, 16))
        self.style.configure("Section.Light.TLabel", background=LIGHT_LEFT_PANEL_BG, foreground=LIGHT_TEXT_DARK, font=(FONT_FAMILY, 18, "bold"))
        self.style.configure("Light.TButton", background=LIGHT_MEDIUM_BG, foreground=LIGHT_TEXT_DARK, bordercolor=BORDER_COLOR, borderwidth=0, relief=tk.FLAT, padding=2, font=(FONT_FAMILY, 12))
        self.style.map("Light.TButton", background=[('active', '#B0B0B0')], relief=[('pressed', tk.FLAT), ('active', tk.FLAT)])
        self.style.configure("Light.TCheckbutton", background=LIGHT_LEFT_PANEL_BG, foreground=LIGHT_TEXT_DARK, font=(FONT_FAMILY, 12))
        self.style.map("Light.TCheckbutton", background=[('active', '#A0A0A0')], foreground=[('active', LIGHT_TEXT_DARK)])
        self.style.configure("Light.TMenubutton", background=LIGHT_MEDIUM_BG, foreground=LIGHT_TEXT_DARK, bordercolor=BORDER_COLOR, borderwidth=0, relief=tk.FLAT, arrowcolor=LIGHT_TEXT_DARK, padding=2, font=(FONT_FAMILY, 16))
        ...
        self.style.configure("Light.TEntry", fieldbackground=LIGHT_MEDIUM_BG, foreground=LIGHT_TEXT_DARK, bordercolor=BORDER_COLOR, borderwidth=0, relief=tk.FLAT, insertcolor=LIGHT_TEXT_DARK, padding=2, font=(FONT_FAMILY, 16))
        self.style.configure("Light.TScrollbar", troughcolor=LIGHT_BG, background=LIGHT_MEDIUM_BG, bordercolor=BORDER_COLOR, arrowcolor=LIGHT_TEXT_DARK, relief=tk.FLAT, arrowsize=12)
    ...
    def update_theme(self):
        ...
        self.user_input.configure(bg=MEDIUM_DARK_BG if self.is_dark_mode.get() else LIGHT_MEDIUM_BG, fg=LIGHT_TEXT if self.is_dark_mode.get() else LIGHT_TEXT_DARK)
    ...
    def _init_ui(self):
        ...
        self.config_menu = tkMenu(self, tearoff=0, bg=MEDIUM_DARK_BG, fg=LIGHT_TEXT, activebackground=SELECT_BG_COLOR, activeforeground=LIGHT_TEXT, relief=tk.FLAT, bd=0, font=(FONT_FAMILY, 16))
        self.settings_menu = tkMenu(self.config_menu, tearoff=0, bg=MEDIUM_DARK_BG, fg=LIGHT_TEXT, activebackground=SELECT_BG_COLOR, activeforeground=LIGHT_TEXT, relief=tk.FLAT, bd=0, font=(FONT_FAMILY, 16))
        ...
        self.chat_list_panel.pack(side=tk.LEFT, fill=tk.Y, padx=(0, 1))
        self.chat_list_panel.pack_propagate(False)
        ttk.Label(self.chat_list_panel, text="Chats", style="Section.TLabel").pack(pady=(8, 4), anchor="w", padx=8)
        ...
        self.chat_listbox = tk.Listbox(self.chat_list_panel, height=30, bg=LEFT_PANEL_BG, fg=LIGHT_TEXT,
                                       ...
                                       relief=tk.FLAT, bd=0, highlightthickness=0, exportselection=False, font=(FONT_FAMILY, 16))
        ...
        ttk.Button(self.chat_list_panel, text="Delete Chat", command=self.delete_selected_thread, style="Dark.TButton").pack(fill=tk.X, pady=(0, 4), padx=8, side=tk.BOTTOM)
        ttk.Button(self.chat_list_panel, text="New Chat", command=self.create_new_conversation, style="Dark.TButton").pack(fill=tk.X, pady=(0, 8), padx=8, side=tk.BOTTOM)
        ...
        self.chat_frame.pack(side=tk.TOP, fill=tk.BOTH, expand=True, pady=(4, 0))
        ...
        # Anchor to top-left (nw) instead of bottom (s), and let the frame expand dynamically
        self.chat_window = self.chat_canvas.create_window((0, 0), window=self.chat_scrollable_frame, anchor="nw")

        # Bind canvas resizing to update the window width
        ...
        self.user_input = scrolledtext.ScrolledText(self.input_area_frame, height=2, bg=MEDIUM_DARK_BG, fg=LIGHT_TEXT,
                                                   insertbackground=LIGHT_TEXT, wrap=tk.WORD, relief=tk.FLAT,
                                                   bd=0, highlightthickness=0, font=(FONT_FAMILY, 16), padx=8, pady=4,
        ...
        self.status_frame.pack(side=tk.BOTTOM, fill=tk.X, pady=(4, 0))
        self.status_window = scrolledtext.ScrolledText(self.status_frame, height=5, wrap=tk.WORD, state=tk.NORMAL,
                                                       ...
                                                       highlightthickness=0, font=(FONT_FAMILY, 14), padx=12, pady=12,
                                                       selectbackground=SELECT_BG_COLOR)
        self.status_window.pack(fill=tk.X, expand=True)
        self.status_window.tag_configure("system", foreground=SYSTEM_TEXT, font=(FONT_FAMILY, 14))
        self.status_window.tag_configure("error", foreground=ERROR_TEXT, font=(FONT_FAMILY, 14, "bold"))
        ...
        ttk.Label(controls_frame, text="Theme", style="Secondary.Dark.TLabel").pack(pady=(4, 0), anchor="w", padx=8)
        ttk.Checkbutton(controls_frame, text="Dark Mode", variable=self.is_dark_mode, command=self.update_theme, style="Dark.TButton").pack(fill=tk.X, pady=2, padx=8)

        # TTS Settings
        ttk.Label(controls_frame, text="TTS Settings", style="Section.TLabel").pack(pady=(8, 4), anchor="w", padx=8)
        ttk.Label(controls_frame, text="TTS Provider", style="Secondary.Dark.TLabel").pack(pady=(4, 0), anchor="w", padx=8)
        tts_options = ["None"]
        ...
        self.tts_provider_menu.pack(fill=tk.X, pady=2, padx=8)

        # ElevenLabs Settings
        self.elevenlabs_settings_frame = ttk.Frame(controls_frame, style="Secondary.TFrame")
        ttk.Label(self.elevenlabs_settings_frame, text="Voice Stability", style="Secondary.Dark.TLabel").pack(pady=(4, 0), anchor="w", padx=8)
        stability_frame = ttk.Frame(self.elevenlabs_settings_frame, style="Secondary.TFrame")
        stability_frame.pack(fill=tk.X, pady=2, padx=8)
        ...
        self.stability_display = ttk.Label(stability_frame, text=f"{self.stability_var.get():.2f}", style="Secondary.Dark.TLabel", font=(FONT_FAMILY, 14))
        self.stability_display.pack(side=tk.RIGHT, padx=4)

        ttk.Label(self.elevenlabs_settings_frame, text="Voice Similarity", style="Secondary.Dark.TLabel").pack(pady=(4, 0), anchor="w", padx=8)
        similarity_frame = ttk.Frame(self.elevenlabs_settings_frame, style="Secondary.TFrame")
        similarity_frame.pack(fill=tk.X, pady=2, padx=8)
        ...
        self.similarity_display = ttk.Label(similarity_frame, text=f"{self.stability_var.get():.2f}", style="Secondary.Dark.TLabel", font=(FONT_FAMILY, 14))
        self.similarity_display.pack(side=tk.RIGHT, padx=4)

        # macOS Native Settings
        self.macos_settings_frame = ttk.Frame(controls_frame, style="Secondary.TFrame")
        ttk.Label(self.macos_settings_frame, text="macOS Voice", style="Secondary.Dark.TLabel").pack(pady=(4, 0), anchor="w", padx=8)
        # Use dynamically fetched voices
        ...
        self.macos_voice_menu.pack(fill=tk.X, pady=2, padx=8)

        # Sesame CSM Settings
        self.sesame_settings_frame = ttk.Frame(controls_frame, style="Secondary.TFrame")
        ttk.Label(self.sesame_settings_frame, text="Sesame Speaker ID", style="Secondary.Dark.TLabel").pack(pady=(4, 0), anchor="w", padx=8)
        self.sesame_speaker_entry = ttk.Entry(self.sesame_settings_frame, textvariable=self.sesame_speaker, style="Dark.TEntry")
        self.sesame_speaker_entry.pack(fill=tk.X, pady=2, padx=8)
        ttk.Button(self.sesame_settings_frame, text="Save Speaker ID", command=self.save_tts_config, style="Dark.TButton").pack(fill=tk.X, pady=(0, 8), padx=8)
        ...
        self.temp_display = ttk.Label(temp_frame, text=f"{self.temperature_var.get():.2f}", style="Secondary.Dark.TLabel", font=(FONT_FAMILY, 14))
        ...
        self.presence_display = ttk.Label(presence_frame, text=f"{self.presence_penalty_var.get():.1f}", style="Secondary.Dark.TLabel", font=(FONT_FAMILY, 14))
        ...
        self.frequency_display = ttk.Label(frequency_frame, text=f"{self.frequency_penalty_var.get():.1f}", style="Secondary.Dark.TLabel", font=(FONT_FAMILY, 14))
        ...
        self.top_p_display = ttk.Label(top_p_frame, text=f"{self.top_p_var.get():.2f}", style="Secondary.Dark.TLabel", font=(FONT_FAMILY, 14))
        ...
        self.system_prompt_text_widget = scrolledtext.ScrolledText(controls_frame, height=6, wrap=tk.WORD,
                                                                 ...
                                                                 relief=tk.FLAT, bd=0, font=(FONT_FAMILY, 16), selectbackground=SELECT_BG_COLOR)
    ...
    def update_tts_settings_visibility(self):
        ...
        if provider == "ElevenLabs":
            self.elevenlabs_settings_frame.pack(fill=tk.X, pady=2, padx=8)
        else:
            self.elevenlabs_settings_frame.pack_forget()
        if provider == "macOS Native":
            self.macos_settings_frame.pack(fill=tk.X, pady=2, padx=8)
        else:
            self.macos_settings_frame.pack_forget()
        # Disabled Sesame CSM for now
        # if provider == "Sesame CSM":
        #     self.sesame_settings_frame.pack(fill=tk.X, pady=2, padx=8)
        # else:
    ...
    def create_tooltip(self, widget, text):
        ...
        label = ttk.Label(tooltip, text=text, background="#FFFFE0", relief=tk.SOLID, borderwidth=1, font=(FONT_FAMILY, 12))
        label.pack()
        tooltip.withdraw()
    ...
    def add_log_message(self, message_text, level="system", timestamp_str=None):
        ...
        message_frame.pack(fill=tk.X, padx=15, pady=10, anchor="w")  # Anchor west (left) for better alignment
        ...
        message_label = ttk.Label(
            ...
            font=(FONT_FAMILY, 16, "bold" if level == "user" else "normal")
        )
        ...
        if level in ["user", "assistant"]:
            ...
            if level == "user":
                edit_button = ttk.Button(
                    button_frame,
                    text="✎",
                    command=lambda: self.edit_message(message_frame, message_label, message_text, level),
                    style="Dark.TButton" if self.is_dark_mode.get() else "Light.TButton",
                    width=1
                )
    ...
    def edit_message(self, message_frame, message_label, original_text, role):
        ...
        edit_text = Text(message_frame, height=3, width=50, bg=MEDIUM_DARK_BG if self.is_dark_mode.get() else LIGHT_MEDIUM_BG, fg=LIGHT_TEXT if self.is_dark_mode.get() else LIGHT_TEXT_DARK, font=(FONT_FAMILY, 16), wrap=tk.WORD)
    ...
    def configure_api_keys(self):
        global openai_api_key, openrouter_api_key, xai_api_key, config
